<?php
	...
	function traduction($typeLangue, $user): array {
		...
		return ["lang" => $lang, 'method4ratio' => $method4ratio, 'method7ratio' => $method7ratio,
		        'gainPresence' => $gainPresence, 'rang' => $rang, 'titre' => $titre, 'h1' => $h1, 'legend1' => $legend1,
		        'method1' => $method1, 'method2' => $method2, 'methode' => $methode, 'selection' => $selection,
		        'btn_methode' => $btn_methode, 'method3' => $method3, 'method4' => $method4, 'method5' => $method5,
		        'method6' => $method6, 'method7' => $method7, "msgInfo_killer_citron" => $msgInfo_killer_citron, 'h3' => $h3,
		        'legend2' => $legend2, 'label1' => $label1, 'label2' => $label2, 'label3' => $label3, 'option' => $option,
		        "les_gagnant_100E" => $les_gagnant_100E, "les_gagnant_150E" => $les_gagnant_150E, 'legend3' => $legend3,
		        'joueur' => $joueur, 'gain' => $gain, 'killer' => $killer, 'victoire' => $victoire, 'fini2' => $fini2,
		        'information_post_tournois' => $information_post_tournois, 'noTournois' => $noTournois,
		        'nbTournois' => $nbTournois, 'date' => $date, 'citron' => $citron, 'msgErreur_joueur' => $msgErreur_joueur,
		        'info_utile' => $info_utile, 'msgErreur_ID' => $msgErreur_ID, 'msgErreur_Date' => $msgErreur_Date,
		        'btnLogin' => $btnLogin, 'btnReturn' => $btnReturn, 'returnUp' => $returnUp,
		        'info_trie_method4_gain' => $info_trie_method4_gain, 'info_trie_method4_ratio' => $info_trie_method4_ratio,
		        'info_trie_method7_killer' => $info_trie_method7_killer, 'info_trie_method7_ratio' => $info_trie_method7_ratio];
	}
