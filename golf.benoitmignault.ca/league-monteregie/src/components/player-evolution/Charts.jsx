        ...
        <div className="player-charts-container">
            ...
            {chartData.length === 0 ? (
                <div className="warning-message">
                    <FaInfoCircle />
                    <span>{error || "Aucune donnée de graphique disponible pour ce joueur."}</span>
                </div>
            ) : (
                <>
                    ...
                    <p className="charts-note">
                        <span className="note-item">
                            ...
                            Classement FedEx et Handicap
                        </span>
                        <span className="note-separator">•</span>
                        <span className="note-item">
                            <span className="note-good">▲</span>
                            Points FedEx
                        </span>
                    </p>
                    <div className="player-charts-grid">
                        <div className="chart-card">
                            <h3 className="chart-card-title">Classement</h3>
