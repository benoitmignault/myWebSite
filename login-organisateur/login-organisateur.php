<?php
    ...
    function traduction($champs) {
        ...
        if ($champs["typeLangue"] === 'francais') {
            $lang = "fr";
            $title = "Connexion pour l'organisateur";
    ...
    function connexionUser($champs, $connMYSQL) {
        ...
        if ($row_cnt == 1){
            if (password_verify($champs['password'], $row['password'])) {
                ...
                header("Location: /login-organisateur/gestion-organisateur/gestion-organisateur.php");
                exit;
            } else {
...
<head>
    ...
    <link rel="shortcut icon" href="login-organisateur-icone.png">
    <link rel="stylesheet" type="text/css" href="login-organisateur.css">
    ...
    <style>
        body {
            ...
            background-image: url("login-organisateur-background.jpg");
    ...
    <div class="content">
        <div class="center">
            ...
            <fieldset>
                ...
                <form method="post" action="login-organisateur.php">
                    <div class="connexion">
