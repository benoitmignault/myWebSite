...
// 2026-06-09, Ajout de la valeur de is_updated & is_open pour savoir si l'événement est en cours de MAJ par l'ajouter de résultats de ronde
$select = "SELECT id, event_name, golf_course, event_date, is_updated, is_open ";
$from = "FROM events ";
