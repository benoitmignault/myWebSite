        ...
        if ($type_langue === 'francais') {
            ...
            $contenu_courriel .= "<body style='font-family: Arial, sans-serif; background-color: #D3D3D3; margin-top: 0; font-size: 16px;'><p>Bonjour !</p>
                                  <p>Ceci est un courriel de courtoisie pour vous permettre de changer votre mot de passe
                                    ...
                                    <table style='border-collapse: collapse; border: 2px solid #666; padding: 10px;'>
                                        <tr><td style='border: 1px solid #666; padding: 10px;'><span style='font-weight: bold;'>Lien Web :</span> </td><td style='border: 1px solid #666; padding: 10px;'><a target=\"_blank\" href=\"https://benoitmignault.ca/login-user/reset-pwd/reset-pwd.php?key=$lien_reset_pwd&langue=$type_langue\">$lien</a></td></tr>
            ...
            $contenu_courriel .= "<body style='font-family: Arial, sans-serif; background-color: #D3D3D3; margin-top: 0; font-size: 16px;'><p>Hello !</p>
                                  <p>This is a courtesy email to allow you to change your password to make new consultations of poker statistics.</p>
                                    <table style='border-collapse: collapse; border: 2px solid #666; padding: 10px;'>
                                        <tr><td style='border: 1px solid #666; padding: 10px;'><span style='font-weight: bold;'>Web link :</span> </td><td style='border: 1px solid #666; padding: 10px;'><a target=\"_blank\" href=\"https://benoitmignault.ca/login-user/reset-pwd/reset-pwd.php?key=$lien_reset_pwd&langue=$type_langue\">$lien</a></td></tr>
    ...
    <div class="content">
        <div class="center">
            ...
            <fieldset>
                ...
                <form id="form" method="post" action="create-email-temp-pwd.php">
                    <div class="connexion">
